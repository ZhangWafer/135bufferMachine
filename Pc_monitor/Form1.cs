    ...
    public partial class Form1 : Form
    {
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    string get_url = "http://" + header_url + "/Interface/Synchronize/PCCommonSynchronize.ashx?pcId=" + recorDataTable.Rows[i][2] + "&cafeteriId=" + recorDataTable.Rows[i][3] + "&cookbookSetInDateId=" + recorDataTable.Rows[i][4] + "&createDate=" + recorDataTable.Rows[i][5];
                    GetFunction(get_url);
                }
                ...
                {
                    string get_url = "http://" + header_url + "/Interface/Synchronize/WorkerCommonSynchronize.ashx?workerId=" + recorDataTable2.Rows[i][2] + "&cafeteriId=" + recorDataTable2.Rows[i][3] + "&cookbookSetInDateId=" + recorDataTable2.Rows[i][4] + "&createDate=" + recorDataTable2.Rows[i][5];
                    GetFunction(get_url);
                }
                ...
                {
                    string get_url = "http://" + header_url + "/Interface/Synchronize/FamilyCommonSynchronize.ashx?familyId=" + recorDataTable3.Rows[i][2] + "&cafeteriId=" + recorDataTable3.Rows[i][3] + "&cookbookSetInDateId=" + recorDataTable3.Rows[i][4] + "&createDate=" + recorDataTable3.Rows[i][5];
                    GetFunction(get_url);
                }
